...
! function(t, e) {
	...
	function n(t, e, n) {
		return e = u(e),
			...
			}(t, s() ? Reflect.construct(e, n || [], u(t)
				.constructor) : e.apply(t, n))
	}
			...
			if (null != n) {
				...
				try {
					if (r = (n = n.call(t))
						...
						for (; !(u = (o = r.call(n))
							.done) && (c.push(o.value), c.length !== e); u = !0);
				} catch (t) {
					s = !0, i = t
				} finally {
					try {
	...
	var h = {},
		...
		k = function(t) {
			console.warn("".concat(C, " ")
				.concat("object" === m(t) ? t.join(" ") : t))
		},
		E = function(t) {
		...
		P = function(t) {
			...
			e = '"'.concat(t, '" is deprecated and will be removed in the next major release.')
				.concat(n ? ' Use "'.concat(n, '" instead.') : ""), B.includes(e) || (B.push(e), k(e))
		},
		T = function(t) {
		...
		tt = function(t, e, n) {
			if (function(t, e) {
				Array.from(t.classList)
					.forEach((function(n) {
						Object.values(b)
							.includes(n) || Object.values(w)
							.includes(n) || Object.values(e.showClass || {})
							.includes(n) || t.classList.remove(n)
					}))
			}(t, e), e.customClass) {
				var o = e.customClass[n];
				o && ("string" == typeof o || o.forEach ? it(t, o) : k("Invalid type of customClass.".concat(n, '! Expected string or iterable object, got "')
					.concat(m(o), '"')))
			}
		},
		et = function(t, e) {
			...
			switch (e) {
				...
				case "textarea":
				case "file":
					return t.querySelector(".".concat(b.popup, " > .")
						.concat(b[e]));
				case "checkbox":
					return t.querySelector(".".concat(b.popup, " > .")
						.concat(b.checkbox, " input"));
				case "radio":
					return t.querySelector(".".concat(b.popup, " > .")
						.concat(b.radio, " input:checked")) || t.querySelector(".".concat(b.popup, " > .")
						.concat(b.radio, " input:first-child"));
				case "range":
					return t.querySelector(".".concat(b.popup, " > .")
						.concat(b.range, " input"));
				default:
					return t.querySelector(".".concat(b.popup, " > .")
						.concat(b.input))
			}
		...
		ot = function(t, e, n) {
			t && e && ("string" == typeof e && (e = e.split(/\s+/)
				.filter(Boolean)), e.forEach((function(e) {
		...
		pt = function(t) {
			return !(!t || !(t.offsetWidth || t.offsetHeight || t.getClientRects()
				.length))
		},
		mt = function(t) {
		...
		yt = '\n <div aria-labelledby="'.concat(b.title, '" aria-describedby="')
		...
		wt = function(t) {
			var e, n = !!(e = O()) && (e.remove(), rt([document.documentElement, document.body], [b["no-backdrop"], b["toast-shown"], b["has-column"]]), !0);
			if (gt()) E("SweetAlert2 requires document to initialize");
				...
				p.appendChild(o),
					...
					function(t) {
						"rtl" === window.getComputedStyle(t)
							.direction && it(O(), b.rtl)
	...
	var xt = {
		...
		Lt = function(t) {
			if (t.input)
				...
				} else E("Unexpected type of input! Expected ".concat(Object.keys(qt)
						.join(" | "), ', got "')
					.concat(t.input, '"'))
		},
		Ot = function(t, e) {
	...
	qt.text = qt.email = qt.password = qt.number = qt.tel = qt.url = qt.search = qt.date = qt["datetime-local"] = qt.time = qt.week = qt.month = function(t, e) {
		...
		return setTimeout((function() {
			if ("MutationObserver" in window) {
				var n = parseInt(window.getComputedStyle(I())
					.width);
				new MutationObserver((function() {
						if (document.body.contains(t)) {
							var o, i = t.offsetWidth + (o = t, parseInt(window.getComputedStyle(o)
								.marginLeft) + parseInt(window.getComputedStyle(o)
								.marginRight));
							i > n ? I()
								.style.width = "".concat(i, "px") : ct(I(), "width", e.width)
						}
					}))
					.observe(t, {
						attributes: !0,
	...
	var Vt = function(t, e) {
		...
		Rt = function() {
			var t = I();
			if (t)
				for (var e = window.getComputedStyle(t)
					.getPropertyValue("background-color"), n = t.querySelectorAll("[class^=swal2-success-circular-line], .swal2-success-fix"), o = 0; o < n.length; o++) n[o].style.backgroundColor = e
		},
		Nt = function(t, e) {
		...
		Ut = function(t) {
			return '<div class="'.concat(b["icon-content"], '">')
				.concat(t, "</div>")
		},
		zt = function(t, e) {
			var n = e.showClass || {};
			t.className = "".concat(b.popup, " ")
				.concat(pt(t) ? n.popup : ""), e.toast ? (it([document.documentElement, document.body], b["toast-shown"]), it(t, b.toast)) : it(t, b.modal), tt(t, e, "popup"), "string" == typeof e.customClass && it(t, e.customClass), e.icon && it(t, b["icon-".concat(e.icon)])
		},
		Kt = function(t) {
			...
			! function(t, e) {
				...
				function(t, e) {
					...
					if (o) {
						...
						if (e.icon || e.iconHtml) {
							if (e.icon && -1 === Object.keys(w)
								.indexOf(e.icon)) return E('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(e.icon, '"')), void st(o);
		...
		te = function(t, e, n) {
			t && (e.isComposing || 229 === e.keyCode || (t.stopKeydownPropagation && e.stopPropagation(), "Enter" === e.key ? ee(e, t) : "Tab" === e.key ? ne(e) : [].concat(Gt, Qt)
				.includes(e.key) ? oe(e.key) : "Escape" === e.key && ie(e, t, n)))
		},
		ee = function(t, e) {
		...
		fe = null,
		pe = function(t) {
			null === fe && (document.body.scrollHeight > window.innerHeight || "scroll" === t) && (fe = parseInt(window.getComputedStyle(document.body)
				.getPropertyValue("padding-right")), document.body.style.paddingRight = "".concat(fe + function() {
				var t = document.createElement("div");
	...
	var ye = function(t) {
		...
		xe = function(t, e) {
			...
			if (n) {
				...
				x(e.inputOptions) || L(e.inputOptions) ? (ke(N()), S(e.inputOptions)
					.then((function(e) {
						t.hideLoading(), o(e)
	...
	var Le = function(t) {
		...
		Ie = function(t, e, n) {
			var o = xt.innerParams.get(t);
			t.disableInput(), Promise.resolve()
				.then((function() {
		...
		He = function(t, e) {
			...
			(n.showLoaderOnDeny && ke(U()), n.preDeny) ? (t.isAwaitingPromise = !0, Promise.resolve()
				.then((function() {
		...
		Ve = function(t, e) {
			var n = xt.innerParams.get(t || je);
			(n.showLoaderOnConfirm && ke(), n.preConfirm) ? (t.resetValidationMessage(), t.isAwaitingPromise = !0, Promise.resolve()
				.then((function() {
		...
		yn = function(t) {
			t.container.onmousedown = function(e) {
				e.target === t.container && e.preventDefault(), t.popup.onmouseup = function(e) {
					t.popup.onmouseup = function() {}, (e.target === t.popup || e.target instanceof HTMLElement && t.popup.contains(e.target)) && (hn = !0)
				}
			}
		},
		bn = function(t, e, n) {
	...
	var Cn = function() {
			if (h.timeout) return function() {
				var t = Y();
				if (t) {
					var e = parseInt(window.getComputedStyle(t)
						.width);
					t.style.removeProperty("transition"), t.style.width = "100%";
					var n = e / parseInt(window.getComputedStyle(t)
						.width) * 100;
	...
	var Bn, Pn = function(t) {
		...
		Tn = Object.freeze({
			...
			argsToParams: function(t) {
				...
				return "object" !== m(t[0]) || wn(t[0]) ? ["title", "html", "icon"].forEach((function(n, o) {
					var i = t[o];
					"string" == typeof i || wn(i) ? e[n] = i : void 0 !== i && E("Unexpected type of ".concat(n, '! Expected "string" or "Element", got ')
						.concat(m(i)))
		...
		xn = function() {
			return a((function t(e, n) {
				...
				key: "stop",
				value: function() {
					return this.started && this.running && (this.running = !1, clearTimeout(this.id), this.remaining -= (new Date)
						.getTime() - this.started.getTime()), this.remaining
				}
			}, {
				key: "increase",
				value: function(t) {
		...
		Ln = function(t) {
			var e = {};
			return Array.from(t.querySelectorAll("swal-param"))
				.forEach((function(t) {
					Vn(t, ["name", "value"]);
		...
		On = function(t) {
			var e = {};
			return Array.from(t.querySelectorAll("swal-function-param"))
				.forEach((function(t) {
					var n = t.getAttribute("name"),
						o = t.getAttribute("value");
		...
		jn = function(t) {
			var e = {};
			return Array.from(t.querySelectorAll("swal-button"))
				.forEach((function(t) {
		...
		Vn = function(t, e) {
			Array.from(t.attributes)
				.forEach((function(n) {
					-1 === e.indexOf(n.name) && k(['Unrecognized attribute "'.concat(n.name, '" on <')
						.concat(t.tagName.toLowerCase(), ">."), "".concat(e.length ? "Allowed attributes are: ".concat(e.join(", ")) : "To set the value, use HTML within the element.")
					])
				}))
		},
		_n = function(t) {
			...
			return a((function t() {
				...
				value: function(t) {
					...
					if (function(t) {
						...
						h.currentInstance._destroy(), o || n({
							isDismissed: !0
						}), J() && ae()
					}
